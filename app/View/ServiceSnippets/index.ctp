<div class="serviceSnippets index">
	<h2><?php echo __('Service Snippets'); ?></h2>
	...
	<tbody>
	<?php foreach ($serviceSnippets as $serviceSnippet): ?>
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $serviceSnippet['ServiceSnippet']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $serviceSnippet['ServiceSnippet']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $serviceSnippet['ServiceSnippet']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
