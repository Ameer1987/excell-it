<div class="contacts index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('twitter_link'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($contact['Contact']['facebook_link']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['twitter_link']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['skype_link']); ?>&nbsp;</td>
