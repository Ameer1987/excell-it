<?php
App::uses('ServiceSnippetPointsController', 'Controller');

/**
 * ServiceSnippetPointsController Test Case
 */
class ServiceSnippetPointsControllerTest extends ControllerTestCase {
