<?php
App::uses('HomeMiddleSnippetsController', 'Controller');

/**
 * HomeMiddleSnippetsController Test Case
 */
class HomeMiddleSnippetsControllerTest extends ControllerTestCase {
