...
<tr>
	...
	<th><?php echo $this->Paginator->sort('image_name', __d('admin', 'image_name'), array('model' => $contactsTableModelAlias));?></th>
	...
	<th><?php echo $this->Paginator->sort('logo_name', __d('admin', 'logo_name'), array('model' => $contactsTableModelAlias));?></th>
...
foreach ($contacts as $contact): ?>
	<tr>
		...
		<td><?php echo h($contact[$contactsTableModelAlias]['image_name']); ?>&nbsp;</td>
		...
		<td><?php echo h($contact[$contactsTableModelAlias]['logo_name']); ?>&nbsp;</td>
		<td class="actions">
